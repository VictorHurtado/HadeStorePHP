...
.grafico{
  ...
  <body>
    ...
    <div class="col-1 col-s-1" style="padding-top:25px;">
      ...
      <div class="col-10 col-s-10" style="padding-left:25%; padding-top:0px;">
          <h1>Egresos de <?php setlocale(LC_ALL,"es_ES"); $meses=array("Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"); echo $meses[$mes-1];  ?> del  <?php echo $anio; ?>    </h1>
      ...
      <div class="col-6 col-s-12">
        ...
        <table class="col-12 col-s-12">
          ...
          <?php
                include "../includes/inclu-egre.php";
          ?>
          </table>
        </div>
	...
	<?php
	for($i=1;$i<=31;$i++){
	$pe=mysqli_query($conexion, "SELECT  sum(valor) as val FROM egresos WHERE year(fecha)=$anio and Month(fecha)=$mes and day(fecha)=$i");
